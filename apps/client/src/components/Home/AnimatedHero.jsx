...
export default function AnimatedHero({
  ...
  const marqueeContent = React.useMemo(() => {
    ...
    return (
      <div
        className="flex w-max animate-marquee hover:[animation-play-state:paused] whitespace-nowrap px-0 h-32 md:h-44 items-center"
        style={{
          ...
          <React.Fragment key={idx}>
            {pair.unit ? (
              ...
              <div className="flex -space-x-8 md:-space-x-10">
                <motion.div
                  className="video-circle w-28 h-28 md:w-32 md:h-32 border-[6px]"
                ...
                <motion.div
                  className="video-circle w-28 h-28 md:w-32 md:h-32 border-[6px] relative z-10"
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-start justify-center overflow-hidden w-full max-w-screen overflow-x-hidden bg-[#FAF9F5] pt-2 md:pt-4"
    >
      ...
      <motion.div
        className="relative z-10 max-w-[95vw] md:max-w-5xl mx-auto px-4 md:px-6 text-center pt-16 md:pt-20 pb-12 flex flex-col items-center justify-center min-h-[85vh] overflow-x-hidden"
        style={{ opacity }}
      >
        ...
        <div className="relative w-full max-w-[95vw] md:max-w-full overflow-hidden mask-gradient-x mb-8 md:mb-12 mx-auto">
        ...
        <motion.h1
          className="text-[2rem] sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-10 leading-[1.1] tracking-tight"
        ...
        {/* Subheadline */}
        <motion.p
          className="text-sm md:text-lg lg:text-xl text-hbm-gray max-w-[100vw] md:max-w-2xl mx-auto mb-10 md:mb-20 px-4 md:px-0 leading-relaxed overflow-hidden whitespace-pre-wrap"
        ...
        >
          {t(
            {
              en: "Connection is not just a feeling.\nConnection is taking an action.",
              he: "חיבור הוא לא רק תחושה.\nחיבור הוא פעולה.",
            },
            lang,
          )}
        </motion.p>
