...
import { hbmAnalytics } from "../utils/analytics.js";
    ...
    <section className="bg-hbm-cream py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-hbm-gray text-lg mb-10 font-sofia max-w-2xl mx-auto">
          {t(
            {
              en: "Get updates on events, connection tips, and HBM news.",
              he: "קבלו עדכונים על אירועים, טיפים לחיבור וחדשות HBM.",
              es: "Actualización sobre eventos, consejos de conexión y noticias de HBM.",
              fr: "Mises à jour sur les événements, astuces de connexion et actualités HBM.",
              de: "Updates zu Events, Verbindungstipps und HBM-Neuigkeiten.",
              ar: "تحديثات حول الفعاليات ونصائح التواصل وأخبار HBM.",
            },
            lang,
          )}
        </p>
