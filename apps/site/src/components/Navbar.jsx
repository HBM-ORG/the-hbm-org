...
const navStructure = [
  { key: "home", path: "/" },
  {
    ...
    subs: [
      ...
      {
        id: "who",
        label: { en: "Who is it for?", he: "למי זה?" },
        href: "/meeter/who",
      },
      {
        id: "features",
        label: { en: "Features", he: "יכולות" },
        href: "/meeter/features",
      },
    ],
  },
...
export default function Navbar() {
  ...
  const [expandedItems, setExpandedItems] = useState(["meeter"]);
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 h-16 md:h-20 grid grid-cols-3 items-center">
          <div className="flex items-center justify-start gap-2 z-[120]">
            ...
            <Link to="/" className="hidden lg:flex items-center mr-4">
              <img
                src="/logos/theHBM%20LOGO@3x.png"
                alt="The HBM"
            ...
            >
              <nav className="flex flex-col gap-4 w-full">
                {navStructure.map((item) => (
                  <div
                    key={item.key}
                    className="border-b border-gray-50 last:border-0 py-3"
                  >
                ...
                <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col">
                  <Link
                    to={global.ctaUrl}
                    className="btn-primary !text-xl !py-5 !rounded-2xl shadow-xl active:scale-95"
                    onClick={() => setMobileOpen(false)}
                  >
                    {t(ui.cta.your8min, lang)}
                  </Link>
