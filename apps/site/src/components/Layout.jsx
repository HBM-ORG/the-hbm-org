  ...
  return (
    <div className="min-h-screen flex flex-col w-full bg-hbm-cream">
      ...
      <div className="whatsapp-float-container">
        {showTooltip && !pathname.startsWith("/knowledge/") && (
          <div
            className="absolute bottom-[72px] right-0 mb-2"
            style={{
              animation:
                "tooltipBounceIn 0.5s cubic-bezier(0.34, 1.56, 0.64, 1) forwards",
            }}
          >
            <div className="relative bg-white rounded-2xl shadow-xl px-4 py-3 max-w-[200px] border border-gray-100">
              ...
              <p
                className="text-xs font-semibold text-hbm-dark leading-snug"
                dir="auto"
              >
                {t(
                  {
        ...
        <span className="whatsapp-label" dir="auto">
          {t(
            {
              en: "Contact Us",
              he: "צרו קשר",
