...
import { Cookie, PieChart, ShieldCheck, Target, X, ArrowLeft } from "lucide-react";
import { updateConsent } from "../../utils/analytics.js";
      ...
      <Drawer.Portal>
        ...
        >
          ...
          <div
            ...
            className="w-full max-w-2xl bg-white border-t border-x border-gray-100 rounded-t-[40px] p-8 md:p-10 shadow-2xl relative"
            tabIndex={-1}
          >
            <button
            ...
            {!showSettings ? (
              <div className="text-center">
                ...
                <h2 className="text-2xl md:text-3xl font-black mb-4 md:mb-6 font-['Sora'] text-hbm-dark tracking-tight">
                  We use cookies
                </h2>
                <p className="text-gray-500 mb-8 md:mb-10 leading-relaxed text-base md:text-lg max-w-lg mx-auto">
                  We use cookies to enhance your experience and deliver personalized
                  content. You can customize your preferences in settings.
                </p>
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <h3 className="text-xl md:text-2xl font-black font-['Sora'] text-hbm-dark">
                      Preferences
                    </h3>
                ...
                <div className="flex items-center justify-between p-4 md:p-5 bg-gray-50/50 rounded-2xl border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-black text-hbm-dark text-sm">
                        Essential Cookies
                      </p>
                ...
                <div className="flex items-center justify-between p-4 md:p-5 bg-gray-50/50 rounded-2xl border border-gray-100">
                  ...
                  >
                    <div
                      className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${settings.analytics ? "right-1" : "left-1"}`}
                    />
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between p-4 md:p-5 bg-gray-50/50 rounded-2xl border border-gray-100">
                  ...
                  >
                    <div
                      className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all ${settings.marketing ? "right-1" : "left-1"}`}
                    />
                  </button>
                </div>
