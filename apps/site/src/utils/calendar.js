/** Google Calendar expects UTC timestamps as yyyymmddThhmmssZ (already ends with Z from toISOString). */
...
/** ICS UTC datetime — must NOT double-append Z (invalid `093000ZZ` breaks Apple Calendar / Outlook). */
