    ...
    <div className="min-h-screen bg-[#FAF9F5] overflow-x-hidden">
      ...
      <section className="bg-[#FAF9F5] pt-20 pb-16">
        <div className="max-w-4xl mx-auto text-center px-6">
          ...
          <h1
            className="text-4xl md:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#6160AB] to-[#F07B3C] leading-tight"
      ...
      {nextEvent && <FeaturedEventCard event={nextEvent} />}
      ...
      <section className="pb-20 bg-[#FAF9F5] w-full min-w-0">
            ...
            >
              {currentEvents.length > 0 ? (
                ...
                <div className="col-span-full text-center py-20 text-gray-400">
                  {t(
                    {
                      en: "No events found for this year.",
                      he: "לא נמצאו אירועים לשנה זו.",
                    },
                    lang,
                  )}
                </div>
      ...
      {/* CTA: Explore the Growth Library (same style as Knowledge → About Us) */}
      <NextPageBridge
        to="/knowledge"
      ...
      <div className="relative h-full bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100">
        ...
        <div className="relative h-64 overflow-hidden bg-gray-100">
          ...
          <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-xl px-3 py-2 shadow-sm text-center min-w-[60px]">
            ...
            <span className="block text-2xl font-bold text-gray-900 font-['Sora']">
              {day}
            </span>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-gray-500 mb-4 font-['Sofia_Sans'] min-w-0">
          ...
          <button className="w-full py-3 bg-gray-100 text-gray-700 rounded-xl font-bold hover:bg-gray-200 transition-colors flex items-center justify-center gap-2">
            ...
            {isPast
              ? t({ en: "View Gallery", he: "צפו בגלריה" }, lang)
              : t({ en: "View Details", he: "פרטים נוספים" }, lang)}
          </button>
        </div>
      </div>
    </motion.div>
