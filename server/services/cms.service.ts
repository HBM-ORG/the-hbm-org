  ...
  if (globalStyling) {
    try {
      await prisma.globalStyling.upsert({
        where: { id: 'default' },
        update: {
          primaryColor: globalStyling.primaryColor || '#6160AB',
          secondaryColor: globalStyling.secondaryColor || '#F07B3C',
          logoUrl: globalStyling.logoUrl || '/logo.png',
          fontFamily: globalStyling.fontFamily || 'Sora, sans-serif',
        },
        create: {
          id: 'default',
          primaryColor: globalStyling.primaryColor || '#6160AB',
