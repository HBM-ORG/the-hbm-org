...
export function getEmailTemplate({
  ...
  const primary =
    typeof styling.primaryColor === "string" ? styling.primaryColor : "#6160AB";
  const secondary =
    typeof styling.secondaryColor === "string" ? styling.secondaryColor : "#F07B3C";
  const signatureUrl =
    typeof styling.signatureUrl === "string" ? styling.signatureUrl : "";
  const logoUrl = typeof styling.logoUrl === "string" ? styling.logoUrl : "/logo.png";
