  ...
  return (
    <div className="min-h-screen bg-hbm-cream">
      ...
      <NextPageBridge 
        ...
        title={{ en: 'View Upcoming Events', he: 'צפו באירועים קרובים' }}
        description={{ en: 'Join our upcoming events and see the magic of genuine connection.', he: 'הצטרפו לאירועים הקרובים שלנו וראו את הקסם של חיבור אמיתי.' }}
        buttonText={{ en: 'View Upcoming Events', he: 'צפו באירועים קרובים' }}
      />
