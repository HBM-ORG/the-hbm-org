...
export default function MeeterFeatures() {
  ...
  return (
    <div className="min-h-screen bg-hbm-cream">
      ...
      {/* Section 4: Customize Meeter (Visual Left, Text Right) */}
      <section className="bg-hbm-cream py-12">
        <div className="max-w-6xl mx-auto px-6 mb-8">
          <h2 className="text-4xl md:text-5xl font-bold text-center text-hbm-dark mb-4">
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="text-hbm-orange text-2xl flex-shrink-0">✓</span>
                  <span className="text-hbm-dark font-medium">
                    {t({ en: 'Upload your custom logo', he: 'העלו את הלוגו המותאם שלכם' }, lang)}
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-hbm-orange text-2xl flex-shrink-0">✓</span>
                  <span className="text-hbm-dark font-medium">
                    {t({ en: 'Set your event title and theme', he: 'הגדירו את כותרת האירוע והנושא' }, lang)}
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-hbm-orange text-2xl flex-shrink-0">✓</span>
                  <span className="text-hbm-dark font-medium">
                    {t(
                      { en: 'Define custom interest categories', he: 'הגדירו קטגוריות עניין מותאמות אישית' },
                      lang
                    )}
                  </span>
                </li>
