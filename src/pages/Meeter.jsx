...
import { ArrowRight, Building2, Users, CalendarDays, GraduationCap, Zap, Globe, BarChart3, MessageCircle, ChevronDown, Check } from 'lucide-react'
...
export default function Meeter() {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section id="what" className="bg-gradient-hero section-padding text-center">
      ...
      {/* Features Grid */}
      <section id="features" className="section-padding bg-hbm-cream">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feat, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 card-hover text-center">
