...
import { CLARITY_ID } from '../../utils/analytics';
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 font-medium leading-relaxed">
                                <strong>GA4:</strong> Add <code className="bg-slate-200 px-1 rounded text-xs">VITE_GA_ID</code> in <code className="bg-slate-200 px-1 rounded text-xs">.env</code> (Measurement ID from GA4 Admin → Data Streams). <strong>Clarity:</strong> Already set (<code className="bg-slate-200 px-1 rounded text-xs">VITE_CLARITY_ID={CLARITY_ID}</code>). After adding GA ID, restart the dev server so tracking loads. Cookie data and registrations sync live in this admin.
                            </p>
                        </div>
                    </div>
                </div>
